...
// const InjectableInsertMediaModal = window.InsertMediaModal
//   ? provideInjector(window.InsertMediaModal.default)
//   : null;

jQuery.entwine('ss', ($) => {
  // $('.js-injector-boot #insert-md-media-react__dialog-wrapper').entwine({
  //   Element: null,
  //   Data: {},
  //   ReactRoot: null,
